...
//Add event listneer, need to be able to store and remove (clears) user input fron local storage
...
//On page reload... any input in local storage needs to be rendered to the correct hour